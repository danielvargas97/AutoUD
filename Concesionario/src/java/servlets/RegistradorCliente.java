 ...
 * @author PC
 */
public class RegistradorCliente extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{               
            ...
            System.out.println("Cliente: [" + c.getNombreCliente() + "] List@");
        } catch (NumberFormatException e) {
            System.out.println("Error --> " + "No tenemos la menor idea de que hacemos");
        } catch (Exception e1) {
